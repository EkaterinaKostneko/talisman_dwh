...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'JSONList Test Extractor',
    ...
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION_PRODUCER': serialize_connection('http_vi_mocker_local'),
                        'AF_PRODUCER': '/app/ws/metadata/df/models/tests/jsonlist/source_jsonlist.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/tests/jsonlist/raw_jsonlist.json'
                        }
                     },
