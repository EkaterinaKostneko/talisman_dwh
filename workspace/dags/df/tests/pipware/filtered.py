...
dag_id = 'df_test_pipware_filtered'
    ...
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION_PRODUCER': serialize_connection('http_dc_mocker'),
                        ...
                        'AF_PRODUCER': '/app/ws/metadata/df/models/tests/pipware/source_filtered.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/tests/pipware/raw_filtered.json',
