...
default_args = {
    'owner': 'airflow',
    'description': 'Simple Rep Execute Income',
...
dag_id = 'df_test_eb_web_rep_execute_income'
metadata_path = '/app/ws/metadata/df/models/tests/ebweb'
producer = 'source_rep_execute_income.json'
consumer = 'raw_rep_execute_income.json'
    ...
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION_PRODUCER': serialize_connection('http_vi_mocker_local'),
                         'AF_PRODUCER': f'{metadata_path}/{producer}',
                         'AF_CONSUMER': f'{metadata_path}/{consumer}',
                        }
                     },
