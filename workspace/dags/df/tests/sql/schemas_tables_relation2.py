...
with DAG('df_test_schemas_tables_relation2', default_args=default_args, schedule_interval=None,
         catchup=False, tags=['test']) as dag:
    prepare_entities = DockerOperator(
        task_id=f'df_test_docker_schemas_tables_relation2',
        image='df_operator:latest',
        api_version='auto',
        auto_remove=True,
        environment={**environment,
                     **{'AF_METADATA_PATH': f'/app/ws/metadata/df/models/tests/sql/test_98/2/test_98_a.json'}
                     },
