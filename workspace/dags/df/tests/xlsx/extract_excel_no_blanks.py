...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'No Blanks Excel Extractor',
...
dag_id = 'df_test_extract_excel_no_blanks'
    ...
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION': serialize_connection('testmssql'),
                        'AF_PRODUCER': '/app/ws/metadata/df/models/tests/xlsx/excel_source_no_blanks.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/tests/xlsx/excel_raw_no_blanks.json'}
                     },
