...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'Triggerable Excel Extractor Simple 2',
...
with DAG('df_test_extract_excel_triggerable_simple_2', default_args=default_args, schedule_interval=None,
         catchup=False, tags=['test']) as dag:
    triggered_task = DockerOperator(
        task_id='df_test_docker_extract_excel_triggerable_simple_2',
        ...
        environment={
            ...
            'AF_RUN_ID': '{{ run_id }}',
            'AF_PRODUCER': '/app/ws/metadata/df/models/tests/xlsx/excel_source_triggerable_simple_2.json',
