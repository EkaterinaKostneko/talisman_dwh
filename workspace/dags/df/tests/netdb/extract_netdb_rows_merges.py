...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'Rows Merges NetDB Extractor',
...
dag_id = 'df_test_extract_netdb_rows_merges'
...
with DAG(dag_id, default_args=default_args, schedule_interval=None, catchup=False, tags=['test']) as dag:
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_PRODUCER': '/app/ws/metadata/df/models/tests/netdb/source_rows_merges.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/tests/netdb/raw_rows_merges.json'}
                     },
