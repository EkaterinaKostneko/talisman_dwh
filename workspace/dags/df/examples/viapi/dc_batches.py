...
dag_id = 'df_example_dc_dimension_batches'
    ...
    extract = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION_PRODUCER': serialize_connection('http_dc_mocker'),
                        ...
                        'AF_PRODUCER': '/app/ws/metadata/df/models/examples/viapi/source_dc_batches.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/examples/viapi/raw_dc_batches.json',
