...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'Op Excel Extractor',
...
dag_id = 'df_example_extract_excel_op'
...
with DAG(dag_id, default_args=default_args, schedule_interval=None, catchup=False, tags=['example']) as dag:
    t1 = DockerOperator(
        task_id=f'{dag_id}.df_example_docker_extract_excel_op',
        image='df_operator:latest',
        api_version='auto',
        auto_remove=True,
        environment={**environment,
                     **{'AF_PRODUCER': '/app/ws/metadata/df/models/examples/xlsx/excel_source_op.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/examples/xlsx/excel_raw_op.json',
                        'AF_UNIT_ID': 1,
