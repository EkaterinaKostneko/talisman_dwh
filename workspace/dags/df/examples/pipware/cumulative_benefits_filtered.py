...
default_args = {
    'owner'                 : 'airflow',
    'description'           : 'Filtered Cumulative Benefits',
...
dag_id = 'df_example_pipware_cumulative_benefits_filtered'
    ...
    t1 = DockerOperator(
        ...
        environment={**environment,
                     **{'AF_DWH_DB_CONNECTION_PRODUCER': serialize_connection('pipware_ugmk'),
                        ...
                        'AF_PRODUCER': '/app/ws/metadata/df/models/examples/pipware/source_cumulative_benefits_filtered.json',
                        'AF_CONSUMER': '/app/ws/metadata/df/models/examples/pipware/raw_cumulative_benefits_filtered.json',
