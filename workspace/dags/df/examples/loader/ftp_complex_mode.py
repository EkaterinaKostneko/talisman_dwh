...
dag_id = 'df_example_loader_ftp_complex_mode'
    ...
    loader = DockerOperator(
        ...
        environment={**environment,
                     ...
                     **{'AF_PROVIDER_CONNECTION': serialize_connection('ftp_local'),
                        ...
                        'AF_LOADER_MODE': 'EMPTY:MULTICONTAINER:UNPACK',
                        ...
                        'AF_LOADER_PATTERN': '^((?!file_fff).)*$',  # исключаем некоторые файлы
